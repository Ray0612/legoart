...
_GAINS = tuple(np.arange(0.62, 1.41, 0.06))
_OFFSETS = tuple(range(-16, 17, 2))


def auto_tone(cells: np.ndarray, palette: Palette, *, max_cells: int = 4000, skip_std: float = 4.0) -> np.ndarray:
